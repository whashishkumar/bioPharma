...
export default function ProductDescription({
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row gap-6 p-8 shadow-md rounded-2xl ">
        ...
        <div className="flex flex-col gap-4 w-full md:w-1/2 sanchez">
          {type && (
          ...
          <h1 className="text-xl font-bold text-gray-900 red-hat">
          ...
          <button
            ...
            className="mt-4 px-6 py-2 bg-[#00A859] text-white font-semibold rounded-md hover:bg-[#00A859] transition cursor-pointer"
          >
            Back to Products
          </button>
        </div>
