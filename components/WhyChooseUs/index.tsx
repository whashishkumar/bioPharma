          ...
          <div className="sub-container flex justify-end items-center !px-0">
            <div className="relative flex items-center justify-center h-[350px] md:w-full md:h-full hidden md:flex">
              ...
              <div className="absolute w-full h-full flex items-center justify-center left-2/4 rotate-slow-reverse animate-rotate-slow">
                {logos?.slice(0, 13).map((logo: any, i: any) => {
                  const total = (logos || logoss).length - 1;
                  const spacingFactor = 2.2; // adjust spacing between logos
                  const angle = (i / total) * 1 * Math.PI * spacingFactor;
                  ...
                  return (
                    ...
                    >
                      <Image
                        ...
                        width={80}
                        height={80}
                        className="rounded-md object-contain w-[45px] h-[45px] sm:w-[65px] sm:h-[65px] md:w-[80px] md:h-[80px] lg:w-[120px] lg:h-[70px] rotate-190"
                      />
                    </div>
                  );
                })}
          ...
          <div className="relative sub-container px-0">
            <div className="bg-white rounded-r-2xl !px-0 mx-0">
              ...
              <div className="flex lg:justify-center md:justify-end lg:justify-center md:py-16 lg:py-0 lg:ml-18">
                <div className="lg:mt-12 text-gray-800 space-y-8 lg:ml-30 ">
                  <div className="grid grid-cols-1 gap-6 lg:py-12">
                    {custom_fields?.map((item: any, id: any) => (
                      <div key={id} className="flex gap-6 items-start">
                        {item && (
                          <Image
